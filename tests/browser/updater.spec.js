...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v410', 'pandamonium-v411');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v411';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v410';
  const targetCache = bridgeReload ? 'pandamonium-v410' : 'pandamonium-v411';
