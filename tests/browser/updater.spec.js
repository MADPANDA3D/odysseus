...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v414', 'pandamonium-v415');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v415';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v414';
  const targetCache = bridgeReload ? 'pandamonium-v414' : 'pandamonium-v415';
