...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v409', 'pandamonium-v410');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v410';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v409';
  const targetCache = bridgeReload ? 'pandamonium-v409' : 'pandamonium-v410';
