...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v415', 'pandamonium-v416');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v416';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v415';
  const targetCache = bridgeReload ? 'pandamonium-v415' : 'pandamonium-v416';
