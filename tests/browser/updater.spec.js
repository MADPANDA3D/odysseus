...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v412', 'pandamonium-v413');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v413';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v412';
  const targetCache = bridgeReload ? 'pandamonium-v412' : 'pandamonium-v413';
