...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v413', 'pandamonium-v414');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v414';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v413';
  const targetCache = bridgeReload ? 'pandamonium-v413' : 'pandamonium-v414';
