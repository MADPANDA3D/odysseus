...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v408', 'pandamonium-v409');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v409';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v408';
  const targetCache = bridgeReload ? 'pandamonium-v408' : 'pandamonium-v409';
